...
void InitialiseExpandingPlatform(short itemNumber)
{
	...
	//wc - set active by default to prevent save/load display issues
...
void ExpandingPlatformUpdateMutators(short itemNumber)
{
	...
	//wc - I took out translation logic because it makes rendering misaligned with collision
