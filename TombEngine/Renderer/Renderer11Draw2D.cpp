...
TEN::Renderer::RendererHUDBar* g_FreezeBar;
TEN::Renderer::RendererHUDBar* g_AntiGravBar;
TEN::Renderer::RendererHUDBar* g_BaddyBar;
...
namespace TEN::Renderer
{
	void Renderer11::InitialiseGameBars()
	{
		...
		//wc - custom bars
		g_FreezeBar = new RendererHUDBar(m_device.Get(), 20, 32 + 8 + 4, 150, 8, 1, dashColors);
		g_AntiGravBar = new RendererHUDBar(m_device.Get(), 20, 32 + 8 + 4 + 8 + 4, 150, 8, 1, healthColors);
		g_BaddyBar = new RendererHUDBar(m_device.Get(), 240, 32, 300, 8, 1, healthColors);
